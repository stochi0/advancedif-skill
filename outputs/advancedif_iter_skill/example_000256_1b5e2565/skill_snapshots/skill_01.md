...
2. Identify the writer with the highest number of single-syllable words.
3. Identify the writer with the highest number of multi-syllable (3 or more) words.
4. Identify the writer with the highest number of unique words.
5. Count the occurrences of the N-word for each writer.
6. Present the answer clearly, addressing all points.
