...
### Added notes
- When a user requests specific typographic markup (bold, italics) for linguistic items, ensure that each item is both present and formatted exactly once where it appears.
- When the user requires full capitalization of proper names and places, apply capitalization to all occurrences of people and geographic locations.
- Maintain paragraph count and structure constraints strictly: opening, three body, conclusion.
- Avoid first-person pronouns and colloquial phrasing for academic tone.
